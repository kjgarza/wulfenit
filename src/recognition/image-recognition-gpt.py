...
def emotion_recognition():
    ...
    while True:
        ...
        # if (
        #     current_time - last_call_time > cooldown_time
        #     and current_time - response_display_start_time > display_duration
        # ):
        # # Get chatbot response
        # # Get chatbot response
        # # Get chatbot response
        # chatbot_response = generate_chatbot_response(
        #     f"what you see my face {emotion_label}.",
        #     "You know my emotion just by seeing my face, say something about my expression.",
        # )
